...
# Generated on: Wed Dec 24 12:05:19 +03 2025 (Wed Dec 24 09:05:19 UTC 2025)
...
set logfile fv/memory_macro/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/memory_macro -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k hdl/memory_macro.v hdl/sky130_sram_2kbyte_1rw1r_32x512_8.v
elaborate_design -golden -root {memory_macro} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/memory_macro/fv_map.v.gz
elaborate_design -revised -root {memory_macro}
...
#add_name_alias fv/memory_macro/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.memory_macro.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.memory_macro.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.memory_macro.rtl.fv_map.rpt
