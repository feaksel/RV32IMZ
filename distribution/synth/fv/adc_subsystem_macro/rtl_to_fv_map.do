...
# Generated on: Wed Dec 24 14:25:32 +03 2025 (Wed Dec 24 11:25:32 UTC 2025)
...
set logfile fv/adc_subsystem_macro/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/adc_subsystem_macro -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 hdl/adc_subsystem_macro.v
elaborate_design -golden -root {adc_subsystem_macro} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/adc_subsystem_macro/fv_map.v.gz
elaborate_design -revised -root {adc_subsystem_macro}
...
#add_name_alias fv/adc_subsystem_macro/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.adc_subsystem_macro.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.adc_subsystem_macro.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.adc_subsystem_macro.rtl.fv_map.rpt
