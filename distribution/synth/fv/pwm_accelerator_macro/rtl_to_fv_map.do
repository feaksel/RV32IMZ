...
# Generated on: Wed Dec 24 15:20:24 +03 2025 (Wed Dec 24 12:20:24 UTC 2025)
...
set logfile fv/pwm_accelerator_macro/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/pwm_accelerator_macro -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 hdl/pwm_accelerator_macro.v
elaborate_design -golden -root {pwm_accelerator_macro} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pwm_accelerator_macro/fv_map.v.gz
elaborate_design -revised -root {pwm_accelerator_macro}
...
#add_name_alias fv/pwm_accelerator_macro/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.pwm_accelerator_macro.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.pwm_accelerator_macro.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.pwm_accelerator_macro.rtl.fv_map.rpt
