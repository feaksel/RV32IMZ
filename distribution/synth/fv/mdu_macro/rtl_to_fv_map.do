...
# Generated on: Wed Dec 24 09:39:53 +03 2025 (Wed Dec 24 06:39:53 UTC 2025)
...
set logfile fv/mdu_macro/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mdu_macro -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k hdl/mdu.v hdl/mdu_macro.v
elaborate_design -golden -root {mdu_macro} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mdu_macro/fv_map.v.gz
elaborate_design -revised -root {mdu_macro}
...
#add_name_alias fv/mdu_macro/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.mdu_macro.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mdu_macro.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mdu_macro.rtl.fv_map.rpt
