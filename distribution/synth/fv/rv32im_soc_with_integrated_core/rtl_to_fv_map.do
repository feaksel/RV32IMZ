...
# Generated on: Thu Dec 25 11:39:33 +03 2025 (Thu Dec 25 08:39:33 UTC 2025)
...
set logfile fv/rv32im_soc_with_integrated_core/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/rv32im_soc_with_integrated_core -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/public/cadence/installs/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/public/cadence/installs/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/public/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../pnr/outputs/rv32im_integrated/rv32im_integrated_macro_stub.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../pnr/outputs/memory_macro/memory_macro_stub.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../pnr/outputs/protection_macro/protection_macro_stub.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../pnr/outputs/adc_subsystem_macro/adc_subsystem_macro_stub.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../pnr/outputs/pwm_accelerator_macro/pwm_accelerator_macro_stub.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k hdl/soc_integrated/rv32im_soc_complete.v
elaborate_design -golden -root {rv32im_soc_with_integrated_core} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/rv32im_soc_with_integrated_core/fv_map.v.gz
elaborate_design -revised -root {rv32im_soc_with_integrated_core}
...
add_black_box communication_macro -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.rv32im_soc_with_integrated_core.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.rv32im_soc_with_integrated_core.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.rv32im_soc_with_integrated_core.rtl.fv_map.rpt
