...
# Generated on: Wed Dec 24 18:51:27 +03 2025 (Wed Dec 24 15:51:27 UTC 2025)
...
set logfile fv/rv32im_integrated_macro/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/rv32im_integrated_macro -revised fv_map
...
add_search_path hdl/rv32im_integrated -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../pnr/outputs/core_macro/core_macro_stub.v
delete_search_path -all -design -golden
add_search_path hdl/rv32im_integrated -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k hdl/rv32im_integrated/rv32im_integrated_macro.v
elaborate_design -golden -root {rv32im_integrated_macro} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/rv32im_integrated_macro/fv_map.v.gz
elaborate_design -revised -root {rv32im_integrated_macro}
...
add_black_box mdu_macro -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.rv32im_integrated_macro.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.rv32im_integrated_macro.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.rv32im_integrated_macro.rtl.fv_map.rpt
