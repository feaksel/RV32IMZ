...
# Generated on: Wed Dec 24 14:11:29 +03 2025 (Wed Dec 24 11:11:29 UTC 2025)
...
set logfile fv/protection_macro/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/protection_macro -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 hdl/protection_macro.v
elaborate_design -golden -root {protection_macro} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/protection_macro/fv_map.v.gz
elaborate_design -revised -root {protection_macro}
...
#add_name_alias fv/protection_macro/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.protection_macro.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.protection_macro.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.protection_macro.rtl.fv_map.rpt
