...
# Generated on: Thu Dec 18 12:04:23 +03 2025 (Thu Dec 18 09:04:23 UTC 2025)
...
set logfile fv/custom_riscv_core/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/custom_riscv_core -revised fv_map
...
add_search_path ../pdk/sky130A/libs.ref -library -both
read_library -liberty -both \
    /home/Student3/Documents/Masaustu/FurkanEmir/RV32IMZ/distribution/rv32im_core_only/synthesis_cadence/../pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib \
    /home/Student3/Documents/Masaustu/FurkanEmir/RV32IMZ/distribution/rv32im_core_only/synthesis_cadence/../pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/riscv_defines.vh ../rtl/alu.v ../rtl/regfile.v ../rtl/decoder.v ../rtl/mdu.v ../rtl/csr_unit.v ../rtl/exception_unit.v ../rtl/custom_riscv_core.v
elaborate_design -golden -root {custom_riscv_core} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/custom_riscv_core/fv_map.v.gz
elaborate_design -revised -root {custom_riscv_core}
...
#add_name_alias fv/custom_riscv_core/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.custom_riscv_core.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.custom_riscv_core.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.custom_riscv_core.rtl.fv_map.rpt
