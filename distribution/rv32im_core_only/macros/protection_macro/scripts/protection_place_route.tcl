#===============================================================================
# Cadence Innovus Place and Route Script - Protection Macro
...
set NETLIST_PATH "outputs/protection_macro_netlist.v"
set SDC_PATH "outputs/protection_macro_constraints.sdc"
...
set MMMC_SCRIPT "mmmc/protection_macro_mmmc.tcl"
...
if {![file exists $MMMC_SCRIPT]} {
    ...
    puts $mmmc_file "# MMMC Script for Protection Macro"
    puts $mmmc_file "\n# Create library set"
...
# Set design name
set init_design_name protection_macro
...
if {[file exists scripts/protection_pin_placement.tcl]} {
    source scripts/protection_pin_placement.tcl
}
...
puts "\n======================================="
puts "Protection Macro P&R Complete!"
puts "======================================="
puts ""
puts "Output files (if successful):"
puts "  outputs/protection_macro.gds - Layout"
puts "  outputs/protection_macro.lef - Abstract view"
puts "  outputs/protection_macro.def - DEF file"
puts ""
puts "Reports:"
