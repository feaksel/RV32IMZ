#===============================================================================
# Cadence Genus Synthesis Script - Protection Macro
# Based on proven working synthesis.tcl
# For: Protection Macro (Security features)
#===============================================================================
...
#===============================================================================
# Read RTL - Protection Macro Dependencies
#===============================================================================

puts "Reading RTL files..."

# Read protection macro RTL
read_hdl -v2001 {
    protection_macro.v
}
...
write_hdl > outputs/protection_macro_netlist.v

# Write netlist for hierarchical integration (used by soc_integration)
write_hdl > outputs/protection_macro_syn.v

# Write SDC constraints for P&R
write_sdc > outputs/protection_macro_constraints.sdc

# Write design database for Innovus
write_design -innovus -base_name outputs/protection_macro_design
...
puts "\n========================================="
puts "Protection Macro Synthesis Complete!"
puts "========================================="
puts ""
...
puts ""
puts "Output files:"
puts "  outputs/protection_macro_netlist.v    - Gate-level netlist"
puts "  outputs/protection_macro_constraints.sdc - Timing constraints"
puts "  outputs/protection_macro_design/      - Design database for Innovus"
puts ""