#===============================================================================
# Cadence Innovus Place and Route Script - Memory Macro
...
set NETLIST_PATH "outputs/memory_macro_netlist.v"
set SDC_PATH "outputs/memory_macro_constraints.sdc"
...
set MMMC_SCRIPT "../mmmc/memory_macro_mmmc.tcl"
...
if {![file exists $MMMC_SCRIPT]} {
    ...
    puts $mmmc_file "# MMMC Script for Memory Macro"
    puts $mmmc_file "\n# Create library set"
...
# Set design name
set init_design_name memory_macro
...
if {[file exists scripts/memory_pin_placement.tcl]} {
    source scripts/memory_pin_placement.tcl
}
...
# Write output files
catch {streamOut outputs/memory_macro.gds -mapFile /home/furka/RV32IMZ/pdk/sky130A/libs.tech/klayout/sky130A.gds.map}
catch {write_lef_abstract outputs/memory_macro.lef}
catch {defOut outputs/memory_macro.def}
...
puts "\n======================================="
puts "Memory Macro P&R Complete!"
puts "======================================="
puts ""
puts "Output files (if successful):"
puts "  outputs/memory_macro.gds - Layout"
puts "  outputs/memory_macro.lef - Abstract view"
puts "  outputs/memory_macro.def - DEF file"
puts ""
puts "Reports:"
