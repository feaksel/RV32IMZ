...
if {[file exists scripts/communication_pin_placement.tcl]} {
    source scripts/communication_pin_placement.tcl
}
...
# Write output files
catch {streamOut outputs/communication_macro.gds -mapFile $env(PDK_ROOT)/sky130A/libs.tech/klayout/sky130A.gds.map}
