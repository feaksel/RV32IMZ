# Pin Placement for Communication Macro
# Assigns physical locations to I/O ports for predictable SoC integration

puts "INFO: Applying pin placement for communication_macro..."
...
editPin -pin wb_dat_i[*] -edge LEFT -layer met2 -spreadType spread -start {25.0 0.0}
...
#==============================================================================
# UART Interface - BOTTOM edge (to external pads)
#==============================================================================

editPin -pin uart_tx -edge BOTTOM -layer met3 -spreadType center -start {10.0 0.0}
editPin -pin uart_rx -edge BOTTOM -layer met3 -spreadType center -start {15.0 0.0}

#==============================================================================
# SPI Interface - BOTTOM edge (to external pads)
#==============================================================================

editPin -pin spi_sclk -edge BOTTOM -layer met3 -spreadType center -start {25.0 0.0}
editPin -pin spi_mosi -edge BOTTOM -layer met3 -spreadType center -start {30.0 0.0}
editPin -pin spi_miso -edge BOTTOM -layer met3 -spreadType center -start {35.0 0.0}
editPin -pin spi_cs -edge BOTTOM -layer met3 -spreadType center -start {40.0 0.0}

puts "INFO: Pin placement complete for communication_macro"
