#===============================================================================
# Cadence Genus Synthesis Script - PWM Accelerator Macro
...
#===============================================================================
# Read RTL - PWM Accelerator Macro Dependencies
#===============================================================================

puts "Reading RTL files..."

# Read PWM accelerator macro RTL
read_hdl -v2001 {
...
elaborate pwm_accelerator_macro
...
if {[file exists "../constraints/pwm_accelerator_macro.sdc"]} {
    read_sdc ../constraints/pwm_accelerator_macro.sdc
} else {
...
write_design -innovus -base_name outputs/pwm_accelerator_macro_design
...
puts "\n========================================="
puts "PWM Accelerator Macro Synthesis Complete!"
puts "========================================="
puts ""
...
puts ""
puts "Output files:"
puts "  outputs/pwm_accelerator_macro_netlist.v    - Gate-level netlist"
puts "  outputs/pwm_accelerator_macro_constraints.sdc - Timing constraints"
puts "  outputs/pwm_accelerator_macro_design/      - Design database for Innovus"
puts ""