#===============================================================================
# Cadence Innovus Place and Route Script - PWM Accelerator Macro
...
set NETLIST_PATH "outputs/pwm_accelerator_macro_netlist.v"
set SDC_PATH "outputs/pwm_accelerator_macro_constraints.sdc"
...
set MMMC_SCRIPT "../mmmc/pwm_accelerator_macro_mmmc.tcl"
...
if {![file exists $MMMC_SCRIPT]} {
    ...
    puts $mmmc_file "# MMMC Script for PWM Accelerator Macro"
    puts $mmmc_file "\n# Create library set"
...
# Set design name
set init_design_name pwm_accelerator_macro
...
# Write output files
catch {streamOut outputs/pwm_accelerator_macro.gds -mapFile /home/furka/RV32IMZ/pdk/sky130A/libs.tech/klayout/sky130A.gds.map}
catch {write_lef_abstract outputs/pwm_accelerator_macro.lef}
catch {defOut outputs/pwm_accelerator_macro.def}
...
puts "\n======================================="
puts "PWM Accelerator Macro P&R Complete!"
puts "======================================="
puts ""
puts "Output files (if successful):"
puts "  outputs/pwm_accelerator_macro.gds - Layout"
puts "  outputs/pwm_accelerator_macro.lef - Abstract view"
puts "  outputs/pwm_accelerator_macro.def - DEF file"
puts ""
puts "Reports:"
