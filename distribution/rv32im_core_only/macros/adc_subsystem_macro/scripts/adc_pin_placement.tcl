# Pin Placement for ADC Subsystem Macro
# Assigns physical locations to I/O ports for predictable SoC integration

puts "INFO: Applying pin placement for adc_subsystem_macro..."
...
#==============================================================================
# ADC Interface - BOTTOM edge (analog inputs)
#==============================================================================

editPin -pin adc_in[0] -edge BOTTOM -layer met2 -spreadType center -start {10.0 0.0}
editPin -pin adc_in[1] -edge BOTTOM -layer met2 -spreadType center -start {20.0 0.0}
editPin -pin adc_in[2] -edge BOTTOM -layer met2 -spreadType center -start {30.0 0.0}
editPin -pin adc_in[3] -edge BOTTOM -layer met2 -spreadType center -start {40.0 0.0}

puts "INFO: Pin placement complete for adc_subsystem_macro"
