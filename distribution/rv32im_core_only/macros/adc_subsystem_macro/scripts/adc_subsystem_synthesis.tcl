#===============================================================================
# Cadence Genus Synthesis Script - ADC Subsystem Macro
# Based on proven working synthesis.tcl
# For: ADC Subsystem Macro (Thermal monitoring)
#===============================================================================
...
#===============================================================================
# Read RTL - ADC Subsystem Macro Dependencies
#===============================================================================

puts "Reading RTL files..."

# Read ADC subsystem macro RTL
read_hdl -v2001 {
...
if {[file exists "../constraints/adc_subsystem_macro.sdc"]} {
    read_sdc ../constraints/adc_subsystem_macro.sdc
} else {
...
write_hdl > outputs/adc_subsystem_macro_netlist.v

# Write netlist for hierarchical integration (used by soc_integration)
write_hdl > outputs/adc_subsystem_macro_syn.v

# Write SDC constraints for P&R
write_sdc > outputs/adc_subsystem_macro_constraints.sdc

# Write design database for Innovus
write_design -innovus -base_name outputs/adc_subsystem_macro_design
...
puts "\n========================================="
puts "ADC Subsystem Macro Synthesis Complete!"
puts "========================================="
puts ""
...
puts ""
puts "Output files:"
puts "  outputs/adc_subsystem_macro_netlist.v    - Gate-level netlist"
puts "  outputs/adc_subsystem_macro_constraints.sdc - Timing constraints"
puts "  outputs/adc_subsystem_macro_design/      - Design database for Innovus"
puts ""