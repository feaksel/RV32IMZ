#===============================================================================
# Cadence Innovus Place and Route Script - ADC Subsystem Macro
...
if {![file exists $MMMC_SCRIPT]} {
    ...
    puts $mmmc_file "# MMMC Script for ADC Subsystem Macro"
    puts $mmmc_file "\n# Create library set"
...
# Set design name
set init_design_name adc_subsystem_macro
...
if {[file exists scripts/adc_pin_placement.tcl]} {
    source scripts/adc_pin_placement.tcl
}
...
# Write output files
catch {streamOut outputs/adc_subsystem_macro.gds -mapFile /home/furka/RV32IMZ/pdk/sky130A/libs.tech/klayout/sky130A.gds.map}
catch {write_lef_abstract outputs/adc_subsystem_macro.lef}
catch {defOut outputs/adc_subsystem_macro.def}
...
puts "\n======================================="
puts "ADC Subsystem Macro P&R Complete!"
puts "======================================="
puts ""
puts "Output files (if successful):"
puts "  outputs/adc_subsystem_macro.gds - Layout"
puts "  outputs/adc_subsystem_macro.lef - Abstract view"
puts "  outputs/adc_subsystem_macro.def - DEF file"
puts ""
puts "Reports:"
