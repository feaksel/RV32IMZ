...
echo "=== Testing M-extension instruction decode ==="

cat > test_mdu_integration.v << 'EOF'
`timescale 1ns / 1ps
...
echo "Compiling MDU integration test..."
iverilog -I rtl/core -o test_mdu_integration test_mdu_integration.v rtl/core/*.v

if [ $? -eq 0 ]; then
    echo "Running MDU integration test..."
    ./test_mdu_integration
else
    echo "Compilation failed"
fi

echo "=== MDU integration test complete ==="