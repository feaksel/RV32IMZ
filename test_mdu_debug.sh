...
echo "=== Creating DEBUG test for MDU integration ==="

cat > test_mdu_debug.v << 'EOF'
`timescale 1ns / 1ps
...
echo "Compiling MDU debug test..."
iverilog -I rtl/core -o test_mdu_debug test_mdu_debug.v rtl/core/*.v

if [ $? -eq 0 ]; then
    echo "Running MDU debug test..."
    ./test_mdu_debug
else
    echo "Compilation failed"
fi

echo "=== MDU Debug test complete ==="